...
ggplot(AverageFamily, aes(x = clase, y = average))+  geom_col(aes(fill = FO_Family), width = 0.7)+ theme(legend.position = "none", plot.title=element_text(size=20, 
                                    face="bold", 
                                    family="American Typewriter",
                                    color="tomato",
                                    lineheight=1.2),  # title
...
ggsave(file="CARD_BIG_family_average.png", plot=CARD_BIG_family_average, width=30, height=15)
