...
The following figure shows the most represented CARD families by MIBiG classes
...
ggplot(First_10sort.by.family.CARD_MIBiG_FULL,aes(FO_Family)) + geom_bar (width = 0.5) + theme(legend.position = "none",plot.title=element_text(size=20, 
                                    face="bold", 
                                    family="American Typewriter",
                                    color="tomato",
                                    lineheight=1.2),  # title
...
#### Which are the CARD most represented families
## Count uniq BGCs


CARD_families_in_MIBiG<-ggplot(First_10sort.by.family.CARD_MIBiG_FULL,aes(FO_Family)) + geom_bar(aes(fill=clase), width = 0.5) + theme(legend.position = "none",plot.title=element_text(size=20, 
                                    face="bold", 
                                    family="American Typewriter",
                                    color="tomato",
                                    lineheight=1.2),  # title
            ...
            axis.text.x=element_text(size=10, 
                                     ...
                                     vjust=.5),  # X axis text
            axis.text.y=element_text(size=10))  # Y axis text
ggsave(file="CARD_families_in_MIBiG.png", plot=CARD_families_in_MIBiG, width=30, height=15)
