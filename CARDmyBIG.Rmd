...
| Family 4 	| 112 	| class D $\beta$-lactamase Transpeptidase|   
...
which(sortCARD$FO_Family == sort.by.family.CARD_MIBiG_FULL$FO_Family)
...
## PEnsar 
sort.by.family.CARD_MIBiG_FULL$average=(sort.by.family.CARD_MIBiG_FULL$n)/(length(sort.by.family.CARD_MIBiG_FULL$FO_Family))*(length(sort.by.family.CARD_MIBiG_FULL$clase))
# number of families 
